...
public interface UserLogApi {
	...
	/**
	 * @api {post} http://47.93.48.111:8080/api/user/register 用户注册
	 * @apiName register
	 * @apiGroup userLog
	 * @apiVersion 0.1.0
	 * @apiDescription 注册
	...
	/**
	 * @api {post} http://47.93.48.111:8080/api/user/getVerifyCode 获取验证码
	...
	/**
	 * @api {post} http://47.93.48.111:8080/api/user/noteLogin 短信登录
	 * @apiName noteLogin
	 * @apiGroup userLog
	 * @apiVersion 0.1.0
	 * @apiDescription 短信登录
	...
	/**
	 * @api {post} http://47.93.48.111:8080/api/user/pwdLogin 密码登录
	 * @apiName pwdLogin
	 * @apiGroup userLog
	 * @apiVersion 0.1.0
	 * @apiDescription 密码登录
	...
	/**
	 * 
	 * @api {post} http://47.93.48.111:8080/api/user/reLogin 退出登录
	 * 
	 * 
	 * 
	 * @apiName reLogin
	...
	/**
	 * @api {post} http://47.93.48.111:8080/api/user/forgetPwd 忘记密码登录
	 * @apiName forgetPwd
	 * @apiGroup userLog
	 * @apiVersion 0.1.0
	 * @apiDescription 忘记密码
